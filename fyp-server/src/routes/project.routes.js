...
projectRoutes.post('/retrieve/:status',
...
projectRoutes.post('/s/:supervisorId/:status',
    auth.authenticate, // middleware to authenticate request user based on JWT token
...
projectRoutes.patch('/proposal-file/:projectId',
    auth.authenticate, // middleware to authenticate request user based on JWT token
    auth.authorize("student"),  // middleware to authorize role(s) to access the route
    file.save('proposal'), // middleware to save proposal file
    // form.sanitize,  // middleware to sanitize input fields
    validateProject.uploadProposalFileForm, // middleware to enforce certain validations on input fields
    projectController.uploadProposalFile // controller method to handle bussiness logic to update project document with certain fields
);
