...
meetingRoutes.post('/retrieve/:status',
...
meetingRoutes.post('/generate-signature',
    auth.authenticate, // middleware to authenticate request user based on JWT token
    auth.authorize("*"),  // middleware to authorize role(s) to access the route
    meetingController.generateSignature // controller method to handle bussiness logic to update meeting document with certain fields
);
