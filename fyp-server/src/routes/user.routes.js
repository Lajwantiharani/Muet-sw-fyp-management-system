...
userRoutes.post('/retrieve/:roleOrStatus',
...
// current user dashboard details
userRoutes.get('/dashboard/data',
    auth.authenticate, // middleware to authenticate request user based on JWT token
    auth.authorize("*"), // middleware to authorize role(s) to access the route
    userController.dashboard // controller method to retrieve current user dashboard details
);
